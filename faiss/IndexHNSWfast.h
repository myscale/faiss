...
struct ReconstructFromNeighbors2 {
    ...
    explicit ReconstructFromNeighbors2(const IndexHNSWfast& index,
...
struct IndexHNSWfast : Index {
    ...
    explicit IndexHNSWfast (int d = 0, int M = 32, MetricType metric = METRIC_L2);
...
struct IndexHNSWfastPQ : IndexHNSWfast {
    IndexHNSWfastPQ();
    IndexHNSWfastPQ(int d, int pq_m,int bit_size=8,int M=32, MetricType metric = METRIC_L2);
    void train(idx_t n, const float* x) override;
};
...
struct IndexHNSWfastSQ : IndexHNSWfast {
    IndexHNSWfastSQ();
    IndexHNSWfastSQ(int d, ScalarQuantizer::QuantizerType qtype, int M, MetricType metric = METRIC_L2);
};
